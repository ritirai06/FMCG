...
function dlabSettings({language, typography, version, layout, navheaderBg, headerBg, sidebarStyle, sidebarBg, sidebarPosition, headerPosition, containerLayout, direction, primary}) {
...
dlabSettings.prototype.manageLanguage = function() {
...
dlabSettings.prototype.manageSidebarStyle = function() {
    switch(this.sidebarStyle) {
        ...
        case "icon-hover":
            ...
            //     $('#main-wrapper').addClass('iconhover-toggle');
            // });
            // $('.dlabnav').on('mouseleave',function() {
            //     $('#main-wrapper').addClass('iconhover-toggle');
            // });
