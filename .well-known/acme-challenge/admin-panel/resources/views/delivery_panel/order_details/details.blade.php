		...
		<div class="dlabnav">
            <div class="dlabnav-scroll">
				...
				<ul class="metismenu" id="menu">
					...
					<li>
						<a class="has-arrow" href="{{ route('delivery.panel.attendance') }}" aria-expanded="false">
			...
			<div class="col-12 order-right">
				...
				<div class="card">
					<div class="card-body">
						...
						<form method="POST" action="{{ route('delivery.panel.orders.status', ['order' => $order->id]) }}">
							@csrf
							@if($isModalView)
...
<div class="modal fade" id="orderDetailPopup" tabindex="-1" aria-hidden="true">
    ...
    ***********************************-->
	...
	<script>
		...
		if (statusSelect && reasonDiv) {
			const toggleReasonField = function () {
				reasonDiv.style.display = (statusSelect.value === 'Failed' || statusSelect.value === 'Returned') ? 'block' : 'none';
			};
