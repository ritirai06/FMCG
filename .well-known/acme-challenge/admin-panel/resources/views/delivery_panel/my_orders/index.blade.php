			...
			<nav class="navbar navbar-expand">
				...
				<div class="header-left">
					...
					<div class="dropdown-menu dropdown-menu-end">
						...
						<a href="<?php echo e(route('delivery.panel.attendance')); ?>" class="dropdown-item ai-icon">
		...
		<div class="dlabnav">
            <div class="dlabnav-scroll">
				...
				<ul class="metismenu" id="menu">
					...
					<li>
						<a class="has-arrow" href="<?php echo e(route('delivery.panel.attendance')); ?>" aria-expanded="false">
