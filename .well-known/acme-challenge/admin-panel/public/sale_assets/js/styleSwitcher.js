...
(function($) {
    ...
    themeDirectionSelect.on('change', function() {
        ...
        if(html.attr('dir') === "rtl"){
            jQuery('.main-css').attr('href','/sale_assets/css/style-rtl.css');
        }else{
            jQuery('.main-css').attr('href','/sale_assets/css/style.css')
        }
